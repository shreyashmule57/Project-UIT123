...
<body>
		...
		<nav class="navbar navbar-expand-lg  bg-lightx navbar-light">
			...
			<div class="collapse navbar-collapse ml-5 text-center" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link text-uppercase" href="#">sign Up</a>
					</li>
					...
					<div class="col-lg-3 col-md-3 col-sm-12">
						<form>
							<div class="card">
								...
								<div class="card-body">
									<a href="photo carousel.html"><img src=" <?php echo $row['image'] ?>" class="img-fluid mb-2 text-center" alt="Phone" ></a>
	...
	<div class="footer">
		<p>&copy 2020 | All Right Reserved | Made by Project UIT.</p>
	</div>
</body>
</html>